...
- [`cli_and_claude_code.md`](cli_and_claude_code.md) — full setup steps for both `meshapi-code` and
  the MCP server, plus the complete `/help` command list for the CLI
- [`research.md`](research.md) — the full MeshAPI feature inventory (32 features total), of which
  this doc covers the "usable through Claude Code, one way or another" slice
